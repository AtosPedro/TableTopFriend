using DDDTableTopFriend.Application.Characters.Commands.Create;
using DDDTableTopFriend.Application.Characters.Commands.Delete;
using DDDTableTopFriend.Application.Characters.Commands.Update;
using DDDTableTopFriend.Application.Characters.Queries.Get;
using DDDTableTopFriend.Application.Characters.Queries.GetAll;
using DDDTableTopFriend.Contracts.Character;
using Mapster;
using MediatR;

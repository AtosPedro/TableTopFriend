...
public class AudioEffectConfiguration : IEntityTypeConfiguration<AudioEffect>
{
    ...
    {
        builder.ToTable("AudioEffects");
        builder.HasKey(au => au.Id);
        builder.Property(au => au.Id)
            .HasConversion(id=> id.Value, value => AudioEffectId.Create(value));
        builder.Property(au => au.Name).HasMaxLength(50);
        builder.Property(au => au.Description).HasMaxLength(200);
        builder.Property(au => au.AudioLink).HasMaxLength(600);
        builder.Property(au => au.AudioClip);
    }
}
